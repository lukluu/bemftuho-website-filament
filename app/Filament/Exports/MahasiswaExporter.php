...
class MahasiswaExporter extends Exporter
{
    ...
    public static function getColumns(): array
    {
        return [
            ...
            ExportColumn::make('penempatanJabatan.jabatan.nama_jabatan')->label('Jabatan'),
            ExportColumn::make('penempatanJabatan.kabinet.nama_kabinet')->label('Kabinet'),
            ExportColumn::make('penempatanJabatan.kabinet.periode')->label('Periode'),
