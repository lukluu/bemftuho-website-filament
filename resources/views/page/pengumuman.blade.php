@extends('layouts.app')
@section('title', config('app.name') .' - '.'Pengumuman')
@push('styles')
<style>
    .post-content {
        font-size: 1rem;
...
<section class="latest-podcast-section section-padding pengumuman" style="padding-top: 0 !important; padding-bottom: 0 !important; margin-bottom: 0 !important;" id="section_2">
    <div class="container-fluid" style="margin: 0 !important;">
        <div class="row justify-content-center" style="margin-top: 0 !important; margin-bottom: 0 !important;">
            <div class="col-12" style="padding: 0 !important; border:none !important; border-radius: 0 !important;">
                <div class="custom-block" style="height: 75vh; padding: 0 !important; margin-top: 0 !important; border:none !important; border-radius: 0 !important;">
                    <div class="custom-block-icon-wrap h-100" style="border:none !important; border-radius: 0 !important;">
                        <a href="{{ route('pengumuman.show', $pengumuman) }}" class="custom-block-image-wrap h-100 w-100 d-block" style="border:none !important; border-radius: 0 !important;">
                            <img src="{{ asset('storage/'.$pengumuman->image) }}"
                                class=" h-100 w-100"
                                style="object-fit: cover; border:none !important; border-radius: 0 !important;"
                                alt="">
                        </a>
                    </div>
                    {{-- Overlay --}}
                    ...
                    <div class="position-absolute top-50 start-50 translate-middle text-center text-white" style="z-index: 2; width: 100%;">
                        <div class="badge bg-primary bg-gradient rounded-pill mb-2">Pengumuman <i class="bi bi-megaphone"></i></div>
                        <h1 class="mb-2 text-white col-12">
                            <a href="{{ route('pengumuman.show', $pengumuman) }}" class=" text-white col-12">
                                {{ $pengumuman->title }}
                            </a>
                        </h1>
                        <p class="mb-0 text-white">{{ Str::limit(strip_tags($pengumuman->content), 30, '...') }}</p>
                        <a href="{{ route('pengumuman.show', $pengumuman) }}" class=" mt-3 text-white">selengkapnya <i class="bi bi-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-4 col-md-6 mb-5">
                ...
                <div class="mb-3 custom-block">
                    <a href="{{ route('berita.show', [$category, $firstPost]) }}" class="href" style="display: block;">
                        <img src="{{ asset('storage/'.$firstPost->post_image) }}" class="main-image" alt="Artikel Utama" style="width: 100%; object-fit: cover; ">
